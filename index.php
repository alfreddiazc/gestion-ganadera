...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link href="assets/css/AdminLTE.css?n=1" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
    <link href="assets/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
    <!-- Custom CSS -->
    <link href="assets/css/style.css?n=1" rel="stylesheet" type="text/css" />

  </head>
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#88ff4d" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo1.png" alt="Logo" height="150"><br>
      </div><!-- /.login-logo -->
      <?php  
