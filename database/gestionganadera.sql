...
--
-- Volcado de datos para la tabla `afaro`
--
...
--
ALTER TABLE `afaro`
  ADD CONSTRAINT `afaroemp` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`id`),
  ADD CONSTRAINT `afaropotr` FOREIGN KEY (`id_potrero`) REFERENCES `potrero` (`id`),
  ADD CONSTRAINT `afarovege` FOREIGN KEY (`id_vegetacion`) REFERENCES `vegetacion` (`id`);
